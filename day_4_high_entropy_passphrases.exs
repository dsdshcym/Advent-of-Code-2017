...
defmodule PassphrasesTest do
  ...
  describe "part 1" do
    test "\"aa bb cc dd ee\" is valid" do
      assert Passphrases.valid_count("aa bb cc dd ee") == 1
    end

    test "\"aa bb cc dd aa\" is not valie" do
      assert Passphrases.valid_count("aa bb cc dd aa") == 0
    end

    test "multiple inputs" do
      assert Passphrases.valid_count("""
             aa bb cc dd aa
             aa bb cc dd ee
             aa bb cc dd aaa
             """) == 2
    ...
    test "puzzle input" do
      assert Passphrases.valid_count(@input) == 0
    end
  end
end
